    ...
    >
      {PROJECTS.map((project) => (
        <motion.div
          ...
          className="group relative flex flex-col gap-3 p-6 rounded-2xl border border-purple-500/30 bg-[#0d0d1a]/80 backdrop-blur-sm overflow-hidden cursor-pointer transition-all duration-300 shadow-[0_0_20px_rgba(112,66,248,0.15)] hover:border-purple-400/70 hover:shadow-[0_0_24px_rgba(112,66,248,0.45)]"
        >
          {/* card glow on hover */}
